...
export const FORMATS: Record<string, FormatMeta> = {
  ...
  md:   { key: "md",   label: "Markdown",  ext: "md",   category: "markup", color: "text-muted-foreground", bg: "bg-muted/40 border-border" },
  ...
  txt:  { key: "txt",  label: "纯文本",     ext: "txt",  category: "doc",    color: "text-muted-foreground", bg: "bg-muted/40 border-border" },
  rtf:  { key: "rtf",  label: "RTF",       ext: "rtf",  category: "doc",    color: "text-muted-foreground", bg: "bg-muted/40 border-border" },
...
export function fmtMeta(key: string): FormatMeta {
  return FORMATS[key] ?? { key, label: key.toUpperCase(), ext: key, category: "doc", color: "text-muted-foreground", bg: "bg-muted/40 border-border" };
}
